...
def run_dashboard_analysis():
    ...
    backtest_passed = find_signals(data, nasdaq_tickers, offset_days=21, is_backtest=True)
    bt_results = []
    ...
    if not bt_df.empty:
        # 요청하신 대로 1month는 최대 수익률 높은 순 정렬
...
with st.spinner('Scanning Market Data...'):
    curr_df, bt_df, last_update = run_dashboard_analysis()
